 ...
 */
const spawnDiff = (oldFilePath, newFilePath) => {
    return new Promise((resolve, reject) => {
        // '-n' option is used to build a patch in RCS format
        const diffProcess = child_process.spawn('diff', ['-n', oldFilePath, newFilePath]);
        let output = '';
        let errorOutput = '';
 ...
 */
const writeToTempFiles = async ({ oldFilePath, oldContent, newFilePath, newContent, }) => {
    await Promise.all([
 ...
 */
const deleteTempFiles = async (oldFilePath, newFilePath, logger) => {
    await Promise.all([
 ...
 */
const createPatch = async (oldContent, newContent) => {
